...
namespace WordDocumentTemplatingApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            dt.Columns.Add("DebtorADDR");
            dt.Columns.Add("DebtorEmail");
            ...
            nr["DebtorADDR"] = "Address 1";
            nr["DebtorEmail"] = "Address2222@mailer.ng";
            nr["PreferContact"] = "PreferContact ..... 1";
            nr["DebtorName"] = "DebtorName-Name ..... 2222";
            //......
            dt.Rows.Add(nr);


            string sourceFile = @"c:\swiftcoretech\wordtemplate.docx";
            string filePath = @"c:\swiftcoretech\GeneratedDoc.docx";
            Mailmerge(sourceFile, filePath, nr, dt.Columns);

            Console.WriteLine("completed event successfully");
